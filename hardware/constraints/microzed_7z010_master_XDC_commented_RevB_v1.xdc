...
#ch 1
set_input_delay -clock [get_clocks DATA_CLK] -clock_fall -min -add_delay 10.000 [get_ports CH_*_A]
set_input_delay -clock [get_clocks DATA_CLK] -clock_fall -max -add_delay 15.000 [get_ports CH_*_A]
set_input_delay -clock [get_clocks DATA_CLK] -min -add_delay 10.000 [get_ports CH_*_A]
set_input_delay -clock [get_clocks DATA_CLK] -max -add_delay 15.000 [get_ports CH_*_A]
set_input_delay -clock [get_clocks DATA_CLK] -clock_fall -min -add_delay 10.000 [get_ports CH_*_B]
set_input_delay -clock [get_clocks DATA_CLK] -clock_fall -max -add_delay 15.000 [get_ports CH_*_B]
set_input_delay -clock [get_clocks DATA_CLK] -min -add_delay 10.000 [get_ports CH_*_B]
set_input_delay -clock [get_clocks DATA_CLK] -max -add_delay 15.000 [get_ports CH_*_B]
