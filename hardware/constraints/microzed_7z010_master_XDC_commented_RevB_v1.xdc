...
set_property IOSTANDARD LVDS [get_ports {in1a_n[0]}]
...
set_property IOSTANDARD LVDS [get_ports {data_clk_p[0]}]
...
set_property IOSTANDARD LVCMOS18 [get_ports {cs[0]}]
...
set_property IOSTANDARD LVDS [get_ports {enc_n[0]}]
...
set_property IOSTANDARD LVDS [get_ports {enc_p[0]}]

#NET JX2_LVDS_16_N   LOC = G20 | IOSTANDARD = LVCMOS18;  # "JX2_LVDS_16_N"
set_property IOSTANDARD LVDS [get_ports {fr_clk_n[0]}]
set_property DIFF_TERM TRUE [get_ports {fr_clk_n[0]}]
...
set_property IOSTANDARD LVDS [get_ports {fr_clk_p[0]}]
set_property DIFF_TERM TRUE [get_ports {fr_clk_p[0]}]

#NET JX2_LVDS_8_N    LOC = M18 | IOSTANDARD = LVCMOS18;  # "JX2_LVDS_8_N"
set_property IOSTANDARD LVDS [get_ports {in4a_n[0]}]
set_property DIFF_TERM TRUE [get_ports {in4a_n[0]}]
...
set_property IOSTANDARD LVDS [get_ports {in4a_p[0]}]
set_property DIFF_TERM TRUE [get_ports {in4a_p[0]}]

#NET JX2_LVDS_4_N    LOC = E19 | IOSTANDARD = LVCMOS18;  # "JX2_LVDS_4_N"
set_property IOSTANDARD LVDS [get_ports {in4b_n[0]}]
set_property DIFF_TERM TRUE [get_ports {in4b_n[0]}]
...
set_property IOSTANDARD LVDS [get_ports {in4b_p[0]}]
set_property DIFF_TERM TRUE [get_ports {in4b_p[0]}]

#NET JX2_LVDS_12_N   LOC = H17 | IOSTANDARD = LVCMOS18;  # "JX2_LVDS_12_N"
set_property IOSTANDARD LVDS [get_ports {in3b_n[0]}]
set_property DIFF_TERM TRUE [get_ports {in3b_n[0]}]
...
set_property IOSTANDARD LVDS [get_ports {in3b_p[0]}]
set_property DIFF_TERM TRUE [get_ports {in3b_p[0]}]

#NET JX2_LVDS_14_N   LOC = G18 | IOSTANDARD = LVCMOS18;  # "JX2_LVDS_14_N"
set_property IOSTANDARD LVDS [get_ports {in3a_n[0]}]
set_property DIFF_TERM TRUE [get_ports {in3a_n[0]}]
...
set_property IOSTANDARD LVDS [get_ports {in3a_p[0]}]
...
set_input_delay -clock [get_clocks DATA_CLK] -clock_fall -min -add_delay 10.000 [get_ports in*a_p]
set_input_delay -clock [get_clocks DATA_CLK] -clock_fall -max -add_delay 15.000 [get_ports in*a_p]
set_input_delay -clock [get_clocks DATA_CLK] -min -add_delay 10.000 [get_ports in*a_p]
set_input_delay -clock [get_clocks DATA_CLK] -max -add_delay 15.000 [get_ports in*a_p]
set_input_delay -clock [get_clocks DATA_CLK] -clock_fall -min -add_delay 10.000 [get_ports in*b_p]
set_input_delay -clock [get_clocks DATA_CLK] -clock_fall -max -add_delay 15.000 [get_ports in*b_p]
set_input_delay -clock [get_clocks DATA_CLK] -min -add_delay 10.000 [get_ports in*b_p]
set_input_delay -clock [get_clocks DATA_CLK] -max -add_delay 15.000 [get_ports in*b_p]
